...
if ($selectedQ !== '') {
    ...
    // };
    switch ($qPart) {
        case 'Q1':     $qStart = "$qYear-01-01"; $qEnd = "$qYear-03-31"; break;
        case 'Q2':     $qStart = "$qYear-04-01"; $qEnd = "$qYear-06-30"; break;
        case 'Q3':     $qStart = "$qYear-07-01"; $qEnd = "$qYear-09-30"; break;
        case 'Q4':     $qStart = "$qYear-10-01"; $qEnd = "$qYear-12-31"; break;
        case 'H1':     $qStart = "$qYear-01-01"; $qEnd = "$qYear-06-30"; break;
        case 'H2':     $qStart = "$qYear-07-01"; $qEnd = "$qYear-12-31"; break;
        case 'Annual': $qStart = "$qYear-01-01"; $qEnd = "$qYear-12-31"; break;
        default:       $qStart = "$qYear-01-01"; $qEnd = "$qYear-12-31"; break;
    };
    $qPeriod = $selectedQ;
    $qEnd   .= ' 23:59:59';
}
    ...
    <div class="d-flex align-items-center gap-3">
      <div>
        ...
        <div style="font-size:.9rem;color:#64748b">
          ...
          &nbsp;·&nbsp; <span class="print-quarter-label"><?= htmlspecialchars($selectedQ ?: 'All Periods') ?></span>
