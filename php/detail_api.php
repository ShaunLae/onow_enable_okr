...
// Explicitly expose parent_objective_id so the detail panel JS
// can render the parent title as a clickable link via openDetail(id).
$obj['parent_objective_id']  = $obj['parent_objective_id']
    ? (int)$obj['parent_objective_id'] : null;
